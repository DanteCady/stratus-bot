	...
	return (
		...
		>
			...
			<Box sx={{ display: 'flex',  gap: 1  }}>
				<ControlButton icon={<AddIcon/>} text='Add Proxies' variant="contained" color="primary" onClick={openModal}/>
				<ControlButton icon={<PublishIcon/>} text='Import Proxies' variant="contained" color="secondary"/>
				<ControlButton icon={<SpeedIcon/>} text='Test Proxies' variant="contained" color="warning" onClick={clearBadProxies} />
				<ControlButton icon={<ClearIcon/>} text='Clear Bad' variant="contained" color="info"/>
